...
| **Tipo de perguntas** | Baseadas em cenários reais |
| **Quantidade total** | 100 perguntas |
| **Distribuição** | Todas para o nível Júnior |
...
| Coleções e Estruturas de Dados | 15 |
| Tratamento de Exceções | 10 |
| Manipulação de Strings e Datas | 10 |
| Controle de Fluxo e Lógica | 10 |
| Boas Práticas e Debugging | 10 |
...
| **Categorias cobertas** | Fundamentos (1), Orientação a Objetos (2, 5, 7, 10), Exceções (3, 8), Coleções (4), Controle de Fluxo (6), Strings (9) |
| **Perguntas restantes** | 11 a 100 (90 perguntas) |

As próximas perguntas continuarão abordando: polimorfismo avançado, interfaces, generics, streams, tratamento de exceções em cenários reais, debugging, boas práticas, Java Collections Framework, e mais fundamentos da linguagem — sempre no nível Júnior e com foco em cenários reais.

Diga **"continuar"** e eu gero a Parte 2 com as perguntas 11 a 20.

----

# PARTE 2 — Perguntas 11 a 20
...
| **Categorias cobertas** | OO/Interfaces (11), Coleções/HashMap (12), Exceções/Try-with-resources (13), OO/Overloading vs Overriding (14), Fundamentos/Casting (15), Fundamentos/Static (16), Coleções/Iteração (17), Fundamentos/Construtores (18), Coleções/Streams (19), Debugging (20) |
| **Perguntas restantes** | 21 a 100 (80 perguntas) |

As próximas perguntas abordarão: Generics, Lambdas, Optional, Collections avançado, comparação de objetos (`Comparable`/`Comparator`), imutabilidade, boas práticas de naming, conventions, enums, manipulação de datas com `java.time`, e mais cenários de debugging — sempre no nível Júnior com foco em cenários reais.

Diga **"continuar"** e eu gero a Parte 3 com as perguntas 21 a 30.

---

# PARTE 3 — Perguntas 21 a 30
